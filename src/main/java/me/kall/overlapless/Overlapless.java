...
public final class Overlapless {
    ...
    private static final Identifier NONE = Identifier.fromNamespaceAndPath(MOD_ID, "none");

    public Overlapless(IEventBus modBus, Dist dist, ModContainer container) {
        Config.register(container, modBus);
    }

    public static Identifier getName(Structure structure) {
        ...
        Identifier id = optionalStructures.get().getKey(structure);
