...
public class Config {
    private static final IConfigSpec CONFIG;
    ...
    static {
        ...
        SKIPPABLE_FEATURES_CONFIG  = builder
                ...
                .defineListAllowEmpty(Lists.newArrayList("SkippableFeatures"), Lists.newArrayList(), () -> "namespace:path", Predicates.alwaysTrue());
    ...
    public static void register(String modId) {
        NeoForgeConfigRegistry.INSTANCE.register(modId, ModConfig.Type.COMMON, Config.CONFIG);
